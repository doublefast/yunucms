...
class Auth{
    ...
    public function __construct() {
		$this->_config['auth_group'] = config('database.prefix').$this->_config['auth_group'];
		$this->_config['auth_group_access'] = config('database.prefix').$this->_config['auth_group_access'];
		$this->_config['auth_rule'] = config('database.prefix').$this->_config['auth_rule'];
		$this->_config['auth_user'] = config('database.prefix').$this->_config['auth_user'];
